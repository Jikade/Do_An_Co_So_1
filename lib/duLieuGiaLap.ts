...
export type SongTheme = 'pink' | 'red' | 'blue' | 'green' | 'violet' | 'sepia' | 'cyan'
export type Emotion = 'happy' | 'sad' | 'calm' | 'angry' | 'romantic' | 'nostalgic' | 'energetic' | 'stressed'
...
export const translations = {
  vi: {
    ...
    heroDescription: 'AI phát hiện cảm xúc từ khuôn mặt, giọng nói và văn bản để đề xuất âm nhạc phù hợp cho bạn',
  ...
  en: {
    ...
    heroDescription: 'AI detects emotion from face, voice, and text to recommend the perfect soundtrack',
...
export const themePalette: Record<SongTheme, { primary: string; secondary: string }> = {
...
export const mockEmotions: MockEmotionItem[] = [
  { id: 'happy', labelVi: 'Vui vẻ', labelEn: 'Happy', color: '#f59e0b', emoji: '😊' },
  { id: 'calm', labelVi: 'Bình yên', labelEn: 'Calm', color: '#10b981', emoji: '😌' },
  { id: 'energetic', labelVi: 'Năng động', labelEn: 'Energetic', color: '#ef4444', emoji: '⚡' },
  { id: 'romantic', labelVi: 'Lãng mạn', labelEn: 'Romantic', color: '#ec4899', emoji: '💖' },
  { id: 'nostalgic', labelVi: 'Hoài niệm', labelEn: 'Nostalgic', color: '#d97706', emoji: '🕰️' },
  { id: 'sad', labelVi: 'Buồn', labelEn: 'Sad', color: '#3b82f6', emoji: '😢' },
  { id: 'stressed', labelVi: 'Căng thẳng', labelEn: 'Stressed', color: '#64748b', emoji: '😵' },
  { id: 'angry', labelVi: 'Tức giận', labelEn: 'Angry', color: '#dc2626', emoji: '😤' },
]
...
export const mockHistoryRecords: HistoryRecord[] = [
  { id: 'hr1', songId: '1', emotion: 'happy', source: 'multimodal', action: 'played', timestamp: '09:15' },
  { id: 'hr2', songId: '2', emotion: 'romantic', source: 'voice', action: 'liked', timestamp: '10:30' },
  { id: 'hr3', songId: '4', emotion: 'nostalgic', source: 'text', action: 'played', timestamp: '12:05' },
  { id: 'hr4', songId: '5', emotion: 'sad', source: 'face', action: 'skipped', timestamp: '13:20' },
  { id: 'hr5', songId: '6', emotion: 'happy', source: 'multimodal', action: 'played', timestamp: '15:10' },
  { id: 'hr6', songId: '3', emotion: 'energetic', source: 'text', action: 'liked', timestamp: '16:25' },
  { id: 'hr7', songId: '10', emotion: 'calm', source: 'face', action: 'added_to_queue', timestamp: '18:40' },
  { id: 'hr8', songId: '8', emotion: 'romantic', source: 'voice', action: 'played', timestamp: '20:05' },
]
...
export const mockListeningHistory: ListeningHistory[] = mockSongs.slice(0, 8).map((song, index) => ({
  id: `history-${index}`,
  song,
...
export const emotionColors: Record<Emotion, { bg: string; text: string; glow: string }> = {
  happy: { bg: 'bg-amber-500/20', text: 'text-amber-400', glow: 'shadow-amber-500/30' },
  sad: { bg: 'bg-blue-500/20', text: 'text-blue-400', glow: 'shadow-blue-500/30' },
  calm: { bg: 'bg-emerald-500/20', text: 'text-emerald-400', glow: 'shadow-emerald-500/30' },
  angry: { bg: 'bg-red-500/20', text: 'text-red-400', glow: 'shadow-red-500/30' },
  romantic: { bg: 'bg-pink-500/20', text: 'text-pink-400', glow: 'shadow-pink-500/30' },
  nostalgic: { bg: 'bg-orange-500/20', text: 'text-orange-400', glow: 'shadow-orange-500/30' },
  energetic: { bg: 'bg-yellow-500/20', text: 'text-yellow-400', glow: 'shadow-yellow-500/30' },
  stressed: { bg: 'bg-slate-500/20', text: 'text-slate-400', glow: 'shadow-slate-500/30' },
}
